...
<body style="font-family: 'Mochiy Pop One', sans-serif;">
    <main>
        ...
        @endif
        <a href="{{ route('president.create') }}" class="btn btn-primary transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">CREAR UN PRESIDENTE</a>
        ...
        <div class="overflow-x-auto w-full">
            ...
            <tbody>
                @foreach ($presidents_teams as $user_name => $email)
                    <tr>
                    <td>
                    ...
                    <td>
                        {{ $email }}
                        <br/>
                        <span class="badge badge-ghost badge-sm">Presidente de $Equipo</span>
                    </td>
                    <td>
                        <div>
