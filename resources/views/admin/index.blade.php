...
<html lang="es">
    ...
    <body class="bg-gray-200" style="font-family: 'Mochiy Pop One', sans-serif;">
        <main>
        <h1 class="font-bold text-3xl text-center text-gray-500 py-5">Bienvenido a tu Panel de Administración</h1>
        <!-- component -->
          ...
          <div class="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
            <a href="{{ route('player.index') }}">
              <div
                  ...
                  <p class="text-xl font-medium text-slate-700 mt-3">Jugadores</p>
                  <p class="mt-2 text-sm text-slate-500">Ver y Crear Jugadores para los diferentes equipos</p>
              </div>
            </a>
            ...
            <a href="#POSTS">
              <div class="p-10 flex flex-col items-center text-center group   md:lg:xl:border-r hover:bg-slate-50 cursor-pointer">
                  ...
                  <p class="text-xl font-medium text-slate-700 mt-3">POSTS</p>
                  <p class="mt-2 text-sm text-slate-500">Edita o Eliminar Posts de la Liga Barrial</p>
              </div>
            </a>
            <a href="{{ route('presidentaso.index') }}">
              <div class="p-10 flex flex-col items-center text-center group    md:lg:xl:border-r hover:bg-slate-50 cursor-pointer">
                  ...
                  <p class="text-xl font-medium text-slate-700 mt-3">Presidente de Asociación</p>
                  <p class="mt-2 text-sm text-slate-500">Asigna un Presidente de Asociación</p>
              </div>
            </a>
            <a href="{{ route('dashboard') }}">
              <div class="p-10 flex flex-col items-center text-center group     hover:bg-slate-50 cursor-pointer">
                  ...
                  <p class="text-xl font-medium text-slate-700 mt-3">Página de Inicio</p>
                  <p class="mt-2 text-sm text-slate-500">Regresa</p>
              </div>
            </a>

          </div>

          {{-- <div class="w-full bg-indigo-600 shadow-xl shadow-indigo-200 py-10 px-12 my-6 flex justify-between items-center">
              ...
              <button class="px-5 py-3 mx-2 font-medium text-slate-700 shadow-xl  hover:bg-yellow-200 duration-150  bg-yellow-400">BOOK AN APPOINTMENT </button>
          </div> --}}
          <div class="flex pt-11 justify-center h-auto">
            <iframe src="https://gifer.com/embed/P7fY" width="70%" height="50%" frameBorder="0"></iframe>
          </div>
        </div>
